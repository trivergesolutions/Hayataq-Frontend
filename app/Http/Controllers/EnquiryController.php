...
class EnquiryController extends Controller
{
    ...
    /**
     * Homepage "Request a Quote" form — store enquiry in quote_enquiries.
     */
    public function storeQuote(Request $request)
    {
        try {
            ...
            $enquiry = QuoteEnquiry::create([
                ...
                'project_requirement' => $validated['project_requirement'],
                'status'              => 'New',
            ]);
            ...
            Log::error('Quote Enquiry Failed', [
                'message' => $e->getMessage(),
                'file'    => $e->getFile(),
                'line'    => $e->getLine(),
            ]);
