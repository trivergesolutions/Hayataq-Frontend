    ...
    <section class="banner relative" id="banner">
        <div class="container">
            <div class="banner-content">
                <h1 class="heading">Industrial Tools & <br> Onsite Machining Solutions.</h1>
                <p class="text-white mb-4">Providing portable machining, bolt torque and tensioning, flange maintenance,
                    hydrotesting, and hydraulic solutions for safe, efficient, and reliable industrial operations.</p>
                <a href="main-product.html" class="btn  mb-2">Explore Now</a>
            </div>
            <div class="heading_corner">
                <p class="heading_corner1">Built for Industry.</p>
                <p class="heading_corner2">Made to Last.</p>
            </div>
        </div>
    </section>
                ...
                <div class="row spcl-row justify-content-center">
                    ...
                    <div class="col-lg col-md-6 col-6">
                        <div class="we-all">
                            ...
                            <div class="weall-content">
                                <p class="para" style="font-size:16px;">Hydrotest Pumps & Systems</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg col-md-6 col-6">
