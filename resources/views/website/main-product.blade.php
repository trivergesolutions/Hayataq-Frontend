    ...
    <section class="products bg-sky_blue" id="products">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="each-product">
                                ...
                                <div class="eachproduct-content">
                                    ...
                                    <p class="mb-3">
                                        {{ \Illuminate\Support\Str::limit($category->categoryDescription->description, 65) }}
                                    </p>
        ...
        <section class="why-us-section">
            <div class="container-fluid py-4">
                <div class="features-card mx-auto">
                    <div class="row justify-content-center gy-4 gx-4">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 col-xl">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <p class="feature-title">Global Quality Standards</p>
                                    <p class="feature-subtitle">ISO-certified products</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 col-xl">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <p class="feature-title">Onsite Solutions</p>
                                    <p class="feature-subtitle">Minimize downtime</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 col-xl">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="feature-subtitle">From selection to service</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 col-xl">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    <p class="feature-title">Fast &amp; Reliable Delivery</p>
                                    <p class="feature-subtitle">Worldwide shipping</p>
                                </div>
                            </div>
                        </div>

                        <div class="col-12 col-sm-6 col-lg-3 col-xl offset-lg-0">
                            <div class="d-flex align-items-start gap-3">
                                <div class="feature-icon d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-industry"></i>
                                </div>
                                <div>
                                    <p class="feature-title">Trusted by Industries</p>
                                    <p class="feature-subtitle">Oil &amp; Gas, Power, Marine &amp; more</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-md-3 text-lg-end mt-4 mt-lg-0">
                            <a href="{{ route('contactPage') }}" class="contact-button">
                                Contact Our Experts
