<!-- =============== Header =============== -->
{{-- <style>
    Search container ko relative banayein taaki suggestions uske niche absolute baithe
    .search-btn {
        position: relative;
        z-index: 1000;
    }
...
<style>
    /* Container: Suggestion box ko iske andar hi rehna chahiye */
    .header-search {
        /* position: relative; */
        width: 100%;
        /* Parent container ki width cover karega */
    }

    /* Suggestion Box: Responsive & Standard */
    #suggestions-box {
        position: absolute;
        top: calc(100% + 5px);
        /* Input ke thoda niche */
        left: 0;
        width: 100%;
        /* Hamesha input ke barabar rahega */
        background: #fff;
        z-index: 9999;
        ...
        /* Padding aur border width mein add nahi hogi */
    }

    /* Mobile ke liye specific adjustments */
                ...
                if (data.length > 0) {
                    ...
                    data.forEach(product => {
                        ...
                        suggestionsBox.innerHTML += `
                            <a href="/productDetail/${product.id}" class="suggestion-item">
