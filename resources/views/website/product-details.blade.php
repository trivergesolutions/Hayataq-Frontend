...
@section('content')
        ...
        <div class="container">
                    ...
                    <div class="detail-right">
                        ...
                        <form id="enquiryForm" class="price-from">
                            ...
                            <div class="row spcl-row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" name="comapny" class="form-control" placeholder="Business Name"
                                        required>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="btn-wrapper">
                                        ...
                                        @php
                                            ...
                                            $manual = $product->documents->firstWhere('title', 'Manual');
                                        @endphp
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="downloadForm">
                                            ...
                                            <input type="hidden" name="file"
                                                value="{{ isset($manual) ? url($manual->file_path) : '' }}">
            ...
            <div class="description">
                ...
                @if (!empty($product->comparison_accessories) && $product->comparison_accessories->count())
                    ...
                    <h5 class="mt-3">Interchangeable Ratchet Link Options</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="each-product">
                                                ...
                                                <div class="eachproduct-content">
                                                    <a href="#" class="product-title accessory">
                                                        {{ $acc->name }}
                                                    </a>
                                                    ...
                                                    <div class="each-links">
                                                        ...
                                                        @if ($acc->document_url)
                                                            <a class="nav-link" href="{{ $acc->document_url }}"
                                                                target="_blank">
                                                                View Details
                                                            </a>
                                                        @endif
                            ...
                            @php
                                ...
                                */
                                ...
                                for ($i = 0; $i < $totalCols; $i++) {
                                    ...
                                    $normalizedWidths[$i] = max(80, (int) $width);
                                }
                                ...
                                } // 2. SMART GROUPING logic (same as before) $colToGroup=[];
                                $groupMaxRow = [];
                                $currentGroupId = 0;
                                $inGroup = false;
                                for ($c = 0; $c < $totalCols; $c++) {
                            ...
                            @foreach ($data as $rIndex => $row)
                                ...
                                <tr style="{{ $rowMeta['backgroundColor'] ?? '' }}">
                                    @foreach ($row as $cIndex => $cell)
                                        ...
                                        @php
                                            $isFullWidthHeading = $colspan >= $totalCols;
                                        @endphp
                                        ...
                                        @php
                                            ...
                                            for ($i = 0; $i < $colspan; $i++) {
                                                $cellWidth += $normalizedWidths[$cIndex + $i] ?? 80;
                                        } @endphp
                                        <{{ $tag }}
                                            class="{{ $cIndex == 0 && !$isFullWidthHeading ? 'text-start ps-3' : 'text-center' }}"
                ...
                @if (!empty($product->related_items))
                    ...
                    <div class="related-products">
                        <div class="related-product-top">
                            ...
                            <h2 class="subheading">Accessories & Options</h2>
                                                ...
                                                <div class="eachproduct-content">
                                                    ...
                                                    <div class="each-links">
                                                        ...
                                                        @if ($item['type'] === 'product')
                                                            <a class="nav-link"
                                                                href="{{ route('productDetailBySlug', $item['slug']) }}">
                                                                View Details
                                                            </a>
                                                        @endif
    ...
    @if ($product->comparison_accessories)
        <script>
